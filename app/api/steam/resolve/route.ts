...
export async function GET(req: Request) {
    ...
    try {
        ...
        if(isSteam64Id(id)) {
            ...
            steam64id = data.response.steam64id
        }
...
//     if(!vanityurl) {
//         return NextResponse.json({ error: "Missing 'vanityurl' query parameter" }, { status: 400 })
//     }
...
//             return NextResponse.json({ error: "Couldnt resolve vanity URL", raw: resolveData.response }, { status: 404 })
//         }
...
//             return NextResponse.json({ error: "Couldnt find playerdata for this SteamID" }, { status: 404 })
//         }
//         return NextResponse.json({ steam64id })
//     } catch(err) {
//         console.error(err);
//         return NextResponse.json({ error: "Servererror fetching SteamID" }, { status: 500 })
//     }
